...
_ = lambda x:x
#from i18n import _
from electrum_peseta.wallet import WalletStorage, Wallet
from electrum_peseta.util import format_satoshis, set_verbosity
from electrum_peseta.pesetacoin import is_valid
from electrum_peseta.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-peseta create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-peseta setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-peseta setconfig' to change your settings")
        return True
