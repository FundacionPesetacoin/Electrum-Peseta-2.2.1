...
REQUEST_HEADERS = {'Accept': 'application/pesetacoin-paymentrequest', 'User-Agent': 'Electrum-PESETA'}
ACK_HEADERS = {'Content-Type':'application/pesetacoin-payment','Accept':'application/pesetacoin-paymentack','User-Agent':'Electrum-PESETA'}
...
def load_certificates():
    try:
        ...
        print "ca-bundle.crt file should be placed in ~/.electrum-peseta/ca/ca-bundle.crt"
...
class PaymentRequest:
    ...
    def read(self, url):
        ...
        self.id = pesetacoin.sha256(r)[0:16].encode('hex')
    ...
    def read_file(self, key):
        ...
        assert key == pesetacoin.sha256(r)[0:16].encode('hex')
        self.id = key
        self.parse(r)
    ...
    def send_ack(self, raw_tx, refund_addr):
        ...
        paymnt.memo = "Paid using Electrum-PESETA"
...
if __name__ == "__main__":
    ...
    try:
        ...
        print "example url: \"pesetacoin:L1TMxFoMeXLmNADoaqCVFLHqVSkJRnL7Hi?amount=0.0018"
        sys.exit(1)
    ...
    tx = "blah"
    pr.send_ack(tx, refund_addr = "L1TMxFoMeXLmNADoaqCVFLHqVSkJRnL7Hi")
