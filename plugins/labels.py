...
from electrum_peseta_gui.qt import HelpButton, EnterButton
...
class Plugin(BasePlugin):
    ...
    def encode(self, message):
        encrypted = electrum.pesetacoin.aes_encrypt_with_iv(self.encode_password, self.iv, message.encode('utf8'))
        encoded_message = base64.b64encode(encrypted)
        return encoded_message

    def decode(self, message):
        decoded_message = electrum.pesetacoin.aes_decrypt_with_iv(self.encode_password, self.iv, base64.b64decode(message)).decode('utf8')
