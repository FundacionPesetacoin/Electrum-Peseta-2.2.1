...
from electrum_peseta_gui.qt.util import *
...
class Exchanger(threading.Thread):
    ...
    def get_json(self, site, get_string):
        try:
            ...
            connection.request("GET", get_string, headers={"User-Agent":"Electrum-PESETA"})
        except Exception:
            raise
    ...
    def update_bter(self):
        try:
            jsonresp = self.get_json('data.bter.com', '/api/1/ticker/peseta_usd')
        except Exception:
            return
        quote_currencies = {}
        try:
